...
{
    /// <summary>
    /// Configuration settings for working with a Replayable driver.
    /// </summary>
    internal class ReplayableTestConfiguration : TestConfiguration
    {
        public ReplayableTestConfiguration()
        {
